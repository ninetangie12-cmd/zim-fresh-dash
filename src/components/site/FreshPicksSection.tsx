...
import { freshPicksProducts, type Product } from "@/data/catalog";
...
export function FreshPicksSection() {
  const freshItems = freshPicksProducts();
      ...
      <div className="mb-4 flex flex-wrap items-end justify-between gap-3 md:mb-5">
        <div>
          <div className="flex items-center gap-2">
            <span className="grid size-8 place-items-center rounded-lg bg-emerald-100 text-emerald-700 shadow-xs dark:bg-emerald-950/60 dark:text-emerald-400">
          ...
          <p className="mt-1 text-xs font-medium text-slate-secondary md:text-sm">
            Farm-fresh produce, fruits, and bakery essentials delivered crisp.
          </p>
        </div>

        <Link
          to="/category/$slug"
          params={{ slug: "fresh-produce" }}
          className="group inline-flex items-center gap-1.5 text-sm font-bold text-botanical hover:underline"
        >
          <span>View All Fresh (34)</span>
